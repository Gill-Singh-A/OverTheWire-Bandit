# Level 10
The password for the next level is stored in a file named 'data.txt' which contains base64 encoded data.<br /><br />
...
```
As given in the statement, 'data.txt' file contains base64 encoded data, so let's check this using 'cat' command:
```bash
bandit10@bandit:~$ cat data.txt 
VGhlIHBhc3N3b3JkIGlzIDZ6UGV6aUxkUjJSS05kTllGTmI2blZDS3pwaGxYSEJNCg==
```
Here, we can see that the string is ended by 2 '=' signs which indicates that it is base64 encoded data.<br>
So, let's decode that data using 'base64' command:
```bash
bandit10@bandit:~$ base64 --decode data.txt 
The password is 6zPeziLdR2RKNdNYFNb6nVCKzphlXHBM
```
Here, we got the password for the Level 11 of Bandit.<br />
