# Level 7
The password for the next level is stored in a file named 'data.txt' with the password next to the word 'millionth'.<br /><br />
...
/home/bandit7
```
Here, we see that we're in the home directory of the bandit7 user, in which the 'data.txt' file is stored.<br />
...
```
As given in the statement, that the password is next to the word 'millionth', we can use 'cat' command to get the file contents and the 'grep' command to filter out the output:
```bash
bandit7@bandit:~$ cat data.txt | grep millionth
millionth	TESKZC0XvTetK0S9xNwm25STk5iWrBvP
```
Here, we got the password for the Level 8 of Bandit.<br />
